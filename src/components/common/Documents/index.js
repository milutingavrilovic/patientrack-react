...
function Documents(props) {
  ...
  const tableIcons = {
    Add: forwardRef((props, ref) => (
      <AddBox
        {...props}
        ref={ref}
        id="document_add_new_document_button"
        style={{ display: "none" }}
      />
    )),
  ...
  useEffect(() => {
    document
      .querySelector("#document_add_new_document_button_header")
            ...
            <MaterialTable
              ...
              localization={{
                header: {
                  actions: (
                    <div
                      id="document_add_new_document_button_header"
                      onClick={() =>
                        document
                          .querySelector("#document_add_new_document_button")
